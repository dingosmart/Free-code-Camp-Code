...
app.factory('WeatherApi', function($http) {
  ...
  obj.getCurrent = function(city) {
    ...
    var appid = "&APPID=cff8ab80814c850434acdeda7fac8b18"
...
app.controller('MainCtrl', function($scope, WeatherApi) {
  ...
  function CurrentWeather(data) {
    ...
    $scope.Data.pressure=Math.round(0.7500516827*data.main.pressure);
    $scope.Data.sunrise=Date(data.sys.sunrise);
    $scope.Data.sunset=data.sys.sunset;
